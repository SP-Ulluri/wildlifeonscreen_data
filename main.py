    ...
    if len(animal_data) == 0:
        ...
        if len(image_paths) == 0:
            ...
            st.write(
                ...
                + "".join(
                    f'<div class="image-container"><a href="{image[3]}"><img src="{image[3]}" alt="{image[0] + " - " + image[1] + " (" + image[2] + ")"}" height="115.33px"></a> <div class="popup-title"><span>{image[0] + " - " + image[1] + " (" + image[2] + ")"}</span></div></div>'
